...
msgstr "Vous devez passer le nom de fichier d'un livre.\n\n{}\n\nPour plus d'informations, essayez --help."
...
msgid "this version of Crowbook has been compiled without support for proofreading, not generating {}"
msgstr "cette version de Crowbook a été compilée sans le support pour la relecture, {} ne sera pas généré"
...
msgid "this version of Crowbook has been compiled without support for proofreading, not generating HTML file {}"
msgstr "cette version de Crowbook n'a pas été compilée avec le support de la relecture, le fichier HTML {} ne sera pas généré"
